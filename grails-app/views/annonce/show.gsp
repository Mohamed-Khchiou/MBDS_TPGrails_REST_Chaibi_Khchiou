        ...
        <div id="show-annonce" class="content scaffold-show" role="main">
            ...
            <ol class="property-list annonce">
                ...
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="validTill-label"><g:formatDate date="${this.annonce.validTill}"/></div>
                </li>
                ...
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="state-label">
                        <g:if test="${this.annonce.state == java.lang.Boolean.TRUE}">
                            Enabled
                        </g:if>
                        <g:else>
                            Disabled
                ...
                <li class="fieldcontain">
                    ...
                    <div class="property-value" aria-labelledby="author-label"><g:link controller="user" action="show" id="${annonce.author.id}">${this.annonce.author.userName}</g:link></div>
                </li>
